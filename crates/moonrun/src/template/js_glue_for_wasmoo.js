...
const X_OK = 1
const F_OK = 0
const fs_access_flags = [R_OK, W_OK, X_OK, F_OK]
...
const fs_open_flags = [O_RDONLY, O_WRONLY, O_RDWR, O_APPEND, O_CREAT, O_TRUNC, O_EXCL, O_NONBLOCK, O_NOCTTY, O_DSYNC, O_SYNC]
