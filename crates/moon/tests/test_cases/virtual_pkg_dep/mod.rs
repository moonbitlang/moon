...
fn test_indirect_depend_virtual() {
    ...
    // Omit native toolchain commands and their MSVC environment because they
    ...
    .filter(|line| {
        !(line.contains("cc")
            || line.contains("cl.exe")
            || line.contains("libruntime")
            || *line == "  env:"
