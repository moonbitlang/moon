...
fn test_indirect_depend_virtual() {
    ...
    check(
        get_stdout(&dir, ["run", "src/main", "--target", "native", "--dry-run"])
            ...
            .join("\n"),
        expect![[r#"
            moonc build-interface ./src/virtual/pkg.mbti -o ./target/native/release/build/virtual/virtual.mi -i '$MOON_HOME/lib/core/target/native/release/bundle/prelude/prelude.mi:prelude' -pkg indirect_depend_virtual/virtual -pkg-sources indirect_depend_virtual/virtual:./src/virtual -virtual -std-path '$MOON_HOME/lib/core/target/native/release/bundle' -error-format json
            moonc build-package ./src/middle/p.mbt -o ./target/native/release/build/middle/middle.core -pkg indirect_depend_virtual/middle -std-path '$MOON_HOME/lib/core/target/native/release/bundle' -i '$MOON_HOME/lib/core/target/native/release/bundle/prelude/prelude.mi:prelude' -i ./target/native/release/build/virtual/virtual.mi:virtual -pkg-sources indirect_depend_virtual/middle:./src/middle -target native -workspace-path . -all-pkgs ./target/native/release/build/all_pkgs.json
            moonc build-package ./src/main/main.mbt -o ./target/native/release/build/main/main.core -pkg indirect_depend_virtual/main -is-main -std-path '$MOON_HOME/lib/core/target/native/release/bundle' -i ./target/native/release/build/middle/middle.mi:middle -i '$MOON_HOME/lib/core/target/native/release/bundle/prelude/prelude.mi:prelude' -i ./target/native/release/build/virtual/virtual.mi:virtual -pkg-sources indirect_depend_virtual/main:./src/main -target native -workspace-path . -all-pkgs ./target/native/release/build/all_pkgs.json
            moonc build-package ./src/impl/p.mbt -o ./target/native/release/build/impl/impl.core -pkg indirect_depend_virtual/impl -std-path '$MOON_HOME/lib/core/target/native/release/bundle' -i '$MOON_HOME/lib/core/target/native/release/bundle/prelude/prelude.mi:prelude' -pkg-sources indirect_depend_virtual/impl:./src/impl -target native -check-mi ./target/native/release/build/virtual/virtual.mi -impl-virtual -pkg-sources indirect_depend_virtual/virtual:./src/virtual -workspace-path . -all-pkgs ./target/native/release/build/all_pkgs.json
