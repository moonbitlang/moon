...
fn test_virtual_pkg() {
    ...
    check(
        ...
        expect![[r#"
            ...
            moonc build-package ./lib4/hello.mbt -o ./target/wasm-gc/release/build/lib4/lib4.core -pkg username/hello/lib4 -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -pkg-sources username/hello/lib4:./lib4 -target wasm-gc -check-mi ./target/wasm-gc/release/build/lib3/lib3.mi -impl-virtual -pkg-sources username/hello/lib3:./lib3 -workspace-path . -all-pkgs ./target/wasm-gc/release/build/all_pkgs.json
            ...
            moonc build-package ./lib2/hello.mbt -o ./target/wasm-gc/release/build/lib2/lib2.core -pkg username/hello/lib2 -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/build/dummy_lib/dummy_lib.mi:dummy_lib -pkg-sources username/hello/lib2:./lib2 -target wasm-gc -check-mi ./target/wasm-gc/release/build/lib1/lib1.mi -impl-virtual -pkg-sources username/hello/lib1:./lib1 -workspace-path . -all-pkgs ./target/wasm-gc/release/build/all_pkgs.json
