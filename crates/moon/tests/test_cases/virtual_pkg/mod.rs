...
fn test_virtual_pkg() {
    ...
    check(
        ...
        expect![[r#"
            moonc build-interface ./lib3/pkg.mbti -o ./_build/wasm-gc/debug/build/lib3/lib3.mi -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg username/hello/lib3 -pkg-sources username/hello/lib3:./lib3 -virtual -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -error-format json
            moonc build-interface ./lib1/pkg.mbti -o ./_build/wasm-gc/debug/build/lib1/lib1.mi -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg username/hello/lib1 -pkg-sources username/hello/lib1:./lib1 -virtual -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -error-format json
            moonc build-package ./main/main.mbt -o ./_build/wasm-gc/debug/build/main/main.core -pkg username/hello/main -is-main -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./_build/wasm-gc/debug/build/lib1/lib1.mi:lib1 -i ./_build/wasm-gc/debug/build/lib3/lib3.mi:lib3 -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main:./main -target wasm-gc -g -O0 -source-map -workspace-path . -all-pkgs ./_build/wasm-gc/debug/build/all_pkgs.json
            moonc build-package ./lib4/hello.mbt -o ./_build/wasm-gc/debug/build/lib4/lib4.core -pkg username/hello/lib4 -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib4:./lib4 -target wasm-gc -g -O0 -source-map -check-mi ./_build/wasm-gc/debug/build/lib3/lib3.mi -impl-virtual -pkg-sources username/hello/lib3:./lib3 -workspace-path . -all-pkgs ./_build/wasm-gc/debug/build/all_pkgs.json
            ...
            moonc build-package ./lib2/hello.mbt -o ./_build/wasm-gc/debug/build/lib2/lib2.core -pkg username/hello/lib2 -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./_build/wasm-gc/debug/build/dummy_lib/dummy_lib.mi:dummy_lib -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib2:./lib2 -target wasm-gc -g -O0 -source-map -check-mi ./_build/wasm-gc/debug/build/lib1/lib1.mi -impl-virtual -pkg-sources username/hello/lib1:./lib1 -workspace-path . -all-pkgs ./_build/wasm-gc/debug/build/all_pkgs.json
