...
fn test_moon_test_filter_package_dry_run() {
    ...
    check(
        ...
        expect![[r#"
            ...
            moonc build-package ./A/hello.mbt ./A/test.mbt -o ./target/wasm-gc/debug/test/A/A.core -pkg username/hello/A -std-path $MOON_HOME/lib/core/target/wasm-gc/release/bundle -pkg-sources username/hello/A:./A -target wasm-gc -g -O0 -source-map
    ...
    check(
        ...
        expect![[r#"
            ...
            moonc build-package ./lib2/lib.mbt -o ./target/wasm-gc/debug/test/lib2/lib2.core -pkg username/hello/lib2 -std-path $MOON_HOME/lib/core/target/wasm-gc/release/bundle -pkg-sources username/hello/lib2:./lib2 -target wasm-gc -g -O0 -source-map
