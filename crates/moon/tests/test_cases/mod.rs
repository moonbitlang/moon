...
fn test_export_memory_name() {
    ...
    let _ = get_stdout(
        &dir,
        ["build", "--target", "wasm-gc", "--output-wat", "--release"],
    );
...
fn test_moon_run_single_file_dry_run() {
    ...
    check(
        ...
        expect![[r#"
            ...
            cc -o ./_build/native/debug/build/single/single.exe '-I$MOON_HOME/include' -g -fwrapv -fno-strict-aliasing -Og '$MOON_HOME/lib/libmoonbitrun.o' ./_build/native/debug/build/single/single.c ./_build/native/debug/build/runtime.o -lm
...
fn test_specify_source_dir_004() {
    ...
    check(
        get_stdout(&dir, ["run", "nes/t/ed/src/main", "--release"]),
        expect![[r#"
            Hello, world!
        "#]],
    );
