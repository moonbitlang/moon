...
fn test_moon_install_bin() {
    ...
    #[cfg(unix)]
    {
        _1 = top_dir.join("author2.in").join("author2-native.sh");
        _2 = top_dir.join("author2.in").join("author2-js.sh");
        _3 = top_dir.join("author2.in").join("author2-wasm.sh");
        _4 = top_dir.join("author1.in").join("this-is-wasm.sh");
        _5 = top_dir.join("author1.in").join("main-js.sh");
    }
