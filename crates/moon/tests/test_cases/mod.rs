...
fn test_moon_pkg() {
    ...
    check(
        ...
        expect![[r#"
            ...
            moonc check ./pkg/pkg.mbt -w -unused_value-todo -o ./_build/wasm-gc/release/check/pkg/pkg.mi -pkg user/mod/pkg -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources user/mod/pkg:./pkg -target wasm-gc -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check ./pkg/pkg_test.mbt -doctest-only ./pkg/pkg.mbt -include-doctests -w -unused_value-todo -o ./_build/wasm-gc/release/check/pkg/pkg.blackbox_test.mi -pkg user/mod/pkg_blackbox_test -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i ./_build/wasm-gc/release/check/pkg/pkg.mi:pkg -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources user/mod/pkg_blackbox_test:./pkg -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check ./main/main.mbt -o ./_build/wasm-gc/release/check/main/main.mi -pkg user/mod/main -is-main -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i ./_build/wasm-gc/release/check/pkg/pkg.mi:lib -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources user/mod/main:./main -target wasm-gc -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check -doctest-only ./main/main.mbt -include-doctests -o ./_build/wasm-gc/release/check/main/main.blackbox_test.mi -pkg user/mod/main_blackbox_test -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i ./_build/wasm-gc/release/check/pkg/pkg.mi:lib -i ./_build/wasm-gc/release/check/main/main.mi:main -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources user/mod/main_blackbox_test:./main -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
        "#]],
    );
    check(
...
fn test_moon_run_with_cli_args() {
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./main/main_wasm.mbt -o ./_build/wasm-gc/debug/build/main/main.core -pkg username/hello/main -is-main -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main:./main -target wasm-gc -g -O0 -source-map -workspace-path . -all-pkgs ./_build/wasm-gc/debug/build/all_pkgs.json
...
fn test_moon_run_single_file_dry_run() {
    ...
    check(
        &output,
        expect![[r#"
            moonc build-package ./single.mbt -o ./_build/js/debug/build/single/single.core -pkg moon/test/single -is-main -std-path '$MOON_HOME/lib/core/_build/js/release/bundle' -i '$MOON_HOME/lib/core/_build/js/release/bundle/abort/abort.mi:abort' -i '$MOON_HOME/lib/core/_build/js/release/bundle/array/array.mi:array' -i '$MOON_HOME/lib/core/_build/js/release/bundle/encoding/ascii/ascii.mi:ascii' -i '$MOON_HOME/lib/core/_build/js/release/bundle/encoding/base64/base64.mi:base64' -i '$MOON_HOME/lib/core/_build/js/release/bundle/bench/bench.mi:bench' -i '$MOON_HOME/lib/core/_build/js/release/bundle/bigint/bigint.mi:bigint' -i '$MOON_HOME/lib/core/_build/js/release/bundle/bool/bool.mi:bool' -i '$MOON_HOME/lib/core/_build/js/release/bundle/buffer/buffer.mi:buffer' -i '$MOON_HOME/lib/core/_build/js/release/bundle/builtin/builtin.mi:builtin' -i '$MOON_HOME/lib/core/_build/js/release/bundle/byte/byte.mi:byte' -i '$MOON_HOME/lib/core/_build/js/release/bundle/bytes/bytes.mi:bytes' -i '$MOON_HOME/lib/core/_build/js/release/bundle/char/char.mi:char' -i '$MOON_HOME/lib/core/_build/js/release/bundle/cmp/cmp.mi:cmp' -i '$MOON_HOME/lib/core/_build/js/release/bundle/coverage/coverage.mi:coverage' -i '$MOON_HOME/lib/core/_build/js/release/bundle/debug/debug.mi:debug' -i '$MOON_HOME/lib/core/_build/js/release/bundle/deque/deque.mi:deque' -i '$MOON_HOME/lib/core/_build/js/release/bundle/double/double.mi:double' -i '$MOON_HOME/lib/core/_build/js/release/bundle/env/env.mi:env' -i '$MOON_HOME/lib/core/_build/js/release/bundle/error/error.mi:error' -i '$MOON_HOME/lib/core/_build/js/release/bundle/float/float.mi:float' -i '$MOON_HOME/lib/core/_build/js/release/bundle/hashmap/hashmap.mi:hashmap' -i '$MOON_HOME/lib/core/_build/js/release/bundle/hashset/hashset.mi:hashset' -i '$MOON_HOME/lib/core/_build/js/release/bundle/immut/array/array.mi:immut/array' -i '$MOON_HOME/lib/core/_build/js/release/bundle/immut/hashmap/hashmap.mi:immut/hashmap' -i '$MOON_HOME/lib/core/_build/js/release/bundle/immut/hashset/hashset.mi:immut/hashset' -i '$MOON_HOME/lib/core/_build/js/release/bundle/immut/priority_queue/priority_queue.mi:immut/priority_queue' -i '$MOON_HOME/lib/core/_build/js/release/bundle/immut/sorted_map/sorted_map.mi:immut/sorted_map' -i '$MOON_HOME/lib/core/_build/js/release/bundle/immut/sorted_set/sorted_set.mi:immut/sorted_set' -i '$MOON_HOME/lib/core/_build/js/release/bundle/int/int.mi:int' -i '$MOON_HOME/lib/core/_build/js/release/bundle/int16/int16.mi:int16' -i '$MOON_HOME/lib/core/_build/js/release/bundle/int64/int64.mi:int64' -i '$MOON_HOME/lib/core/_build/js/release/bundle/json/json.mi:json' -i '$MOON_HOME/lib/core/_build/js/release/bundle/list/list.mi:list' -i '$MOON_HOME/lib/core/_build/js/release/bundle/math/math.mi:math' -i '$MOON_HOME/lib/core/_build/js/release/bundle/option/option.mi:option' -i '$MOON_HOME/lib/core/_build/js/release/bundle/prelude/prelude.mi:prelude' -i '$MOON_HOME/lib/core/_build/js/release/bundle/priority_queue/priority_queue.mi:priority_queue' -i '$MOON_HOME/lib/core/_build/js/release/bundle/queue/queue.mi:queue' -i '$MOON_HOME/lib/core/_build/js/release/bundle/quickcheck/quickcheck.mi:quickcheck' -i '$MOON_HOME/lib/core/_build/js/release/bundle/random/random.mi:random' -i '$MOON_HOME/lib/core/_build/js/release/bundle/ref/ref.mi:ref' -i '$MOON_HOME/lib/core/_build/js/release/bundle/result/result.mi:result' -i '$MOON_HOME/lib/core/_build/js/release/bundle/set/set.mi:set' -i '$MOON_HOME/lib/core/_build/js/release/bundle/sorted_map/sorted_map.mi:sorted_map' -i '$MOON_HOME/lib/core/_build/js/release/bundle/sorted_set/sorted_set.mi:sorted_set' -i '$MOON_HOME/lib/core/_build/js/release/bundle/quickcheck/splitmix/splitmix.mi:splitmix' -i '$MOON_HOME/lib/core/_build/js/release/bundle/strconv/strconv.mi:strconv' -i '$MOON_HOME/lib/core/_build/js/release/bundle/string/string.mi:string' -i '$MOON_HOME/lib/core/_build/js/release/bundle/test/test.mi:test' -i '$MOON_HOME/lib/core/_build/js/release/bundle/tuple/tuple.mi:tuple' -i '$MOON_HOME/lib/core/_build/js/release/bundle/uint/uint.mi:uint' -i '$MOON_HOME/lib/core/_build/js/release/bundle/uint16/uint16.mi:uint16' -i '$MOON_HOME/lib/core/_build/js/release/bundle/uint64/uint64.mi:uint64' -i '$MOON_HOME/lib/core/_build/js/release/bundle/unit/unit.mi:unit' -i '$MOON_HOME/lib/core/_build/js/release/bundle/encoding/utf16/utf16.mi:utf16' -i '$MOON_HOME/lib/core/_build/js/release/bundle/encoding/utf8/utf8.mi:utf8' -pkg-sources moon/test/single:. -target js -g -O0 -source-map -workspace-path . -all-pkgs ./_build/js/debug/build/all_pkgs.json
    ...
    check(
        &output,
        expect![[r#"
            moonc build-package ./single.mbt -o ./_build/wasm-gc/debug/build/single/single.core -pkg moon/test/single -is-main -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/abort/abort.mi:abort' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/array/array.mi:array' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/encoding/ascii/ascii.mi:ascii' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/encoding/base64/base64.mi:base64' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/bench/bench.mi:bench' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/bigint/bigint.mi:bigint' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/bool/bool.mi:bool' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/buffer/buffer.mi:buffer' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/builtin/builtin.mi:builtin' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/byte/byte.mi:byte' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/bytes/bytes.mi:bytes' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/char/char.mi:char' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/cmp/cmp.mi:cmp' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/coverage/coverage.mi:coverage' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/debug/debug.mi:debug' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/deque/deque.mi:deque' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/double/double.mi:double' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/env/env.mi:env' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/error/error.mi:error' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/float/float.mi:float' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/hashmap/hashmap.mi:hashmap' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/hashset/hashset.mi:hashset' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/immut/array/array.mi:immut/array' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/immut/hashmap/hashmap.mi:immut/hashmap' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/immut/hashset/hashset.mi:immut/hashset' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/immut/priority_queue/priority_queue.mi:immut/priority_queue' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/immut/sorted_map/sorted_map.mi:immut/sorted_map' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/immut/sorted_set/sorted_set.mi:immut/sorted_set' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/int/int.mi:int' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/int16/int16.mi:int16' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/int64/int64.mi:int64' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/json/json.mi:json' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/list/list.mi:list' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/math/math.mi:math' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/option/option.mi:option' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/priority_queue/priority_queue.mi:priority_queue' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/queue/queue.mi:queue' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/quickcheck/quickcheck.mi:quickcheck' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/random/random.mi:random' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/ref/ref.mi:ref' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/result/result.mi:result' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/set/set.mi:set' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/sorted_map/sorted_map.mi:sorted_map' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/sorted_set/sorted_set.mi:sorted_set' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/quickcheck/splitmix/splitmix.mi:splitmix' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/strconv/strconv.mi:strconv' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/string/string.mi:string' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/test/test.mi:test' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/tuple/tuple.mi:tuple' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/uint/uint.mi:uint' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/uint16/uint16.mi:uint16' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/uint64/uint64.mi:uint64' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/unit/unit.mi:unit' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/encoding/utf16/utf16.mi:utf16' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/encoding/utf8/utf8.mi:utf8' -pkg-sources moon/test/single:. -target wasm-gc -g -O0 -source-map -workspace-path . -all-pkgs ./_build/wasm-gc/debug/build/all_pkgs.json
...
fn test_moon_doc_dry_run() {
    ...
    check(
        ...
        expect![[r#"
            moonc check ./src/lib/hello.mbt -o ./_build/wasm-gc/release/check/lib/lib.mi -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib:./src/lib -target wasm-gc -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check ./src/main/main.mbt -o ./_build/wasm-gc/release/check/main/main.mi -pkg username/hello/main -is-main -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i ./_build/wasm-gc/release/check/lib/lib.mi:lib -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main:./src/main -target wasm-gc -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
...
fn test_failed_to_fill_whole_buffer() {
    ...
    let moon_db_path = dir.join("./_build/wasm-gc/release/check/check.moon_db");
...
fn test_moon_check_filter_package() {
    ...
    check(
        ...
        expect![[r#"
            moonc check ./A/hello.mbt ./A/test.mbt ./A/hello_wbtest.mbt -o ./_build/wasm-gc/release/check/A/A.whitebox_test.mi -pkg username/hello/A -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/A:./A -target wasm-gc -whitebox-test -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check ./A/hello.mbt ./A/test.mbt -o ./_build/wasm-gc/release/check/A/A.mi -pkg username/hello/A -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/A:./A -target wasm-gc -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check ./A/hello_test.mbt -doctest-only ./A/hello.mbt -doctest-only ./A/test.mbt -include-doctests -o ./_build/wasm-gc/release/check/A/A.blackbox_test.mi -pkg username/hello/A_blackbox_test -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i ./_build/wasm-gc/release/check/A/A.mi:A -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/A_blackbox_test:./A -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
        "#]],
    );
    ...
    check(
        ...
        expect![[r#"
            ...
            moonc check ./lib/hello.mbt -o ./_build/wasm-gc/release/check/lib/lib.mi -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i ./_build/wasm-gc/release/check/lib2/lib2.mi:lib2 -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib:./lib -target wasm-gc -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check ./main/main.mbt -o ./_build/wasm-gc/release/check/main/main.mi -pkg username/hello/main -is-main -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i ./_build/wasm-gc/release/check/lib/lib.mi:lib -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main:./main -target wasm-gc -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check -doctest-only ./main/main.mbt -include-doctests -o ./_build/wasm-gc/release/check/main/main.blackbox_test.mi -pkg username/hello/main_blackbox_test -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i ./_build/wasm-gc/release/check/lib/lib.mi:lib -i ./_build/wasm-gc/release/check/main/main.mi:main -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main_blackbox_test:./main -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
        "#]],
    );
    ...
    check(
        ...
        expect![[r#"
            moonc check ./lib2/lib.mbt -o ./_build/wasm-gc/release/check/lib2/lib2.mi -pkg username/hello/lib2 -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib2:./lib2 -target wasm-gc -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check ./lib/hello.mbt -o ./_build/wasm-gc/release/check/lib/lib.mi -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i ./_build/wasm-gc/release/check/lib2/lib2.mi:lib2 -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib:./lib -target wasm-gc -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check -doctest-only ./lib/hello.mbt -include-doctests -o ./_build/wasm-gc/release/check/lib/lib.blackbox_test.mi -pkg username/hello/lib_blackbox_test -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i ./_build/wasm-gc/release/check/lib/lib.mi:lib -i ./_build/wasm-gc/release/check/lib2/lib2.mi:lib2 -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib_blackbox_test:./lib -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
        "#]],
    );
}
...
fn test_add_mi_if_self_not_set_in_test_imports() {
    ...
    check(
        ...
        expect![[r#"
            ...
            moonc check ./main/main.mbt -o ./_build/wasm-gc/release/check/main/main.mi -pkg username/hello/main -is-main -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i ./_build/wasm-gc/release/check/lib/lib.mi:lib -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main:./main -target wasm-gc -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check -doctest-only ./main/main.mbt -include-doctests -o ./_build/wasm-gc/release/check/main/main.blackbox_test.mi -pkg username/hello/main_blackbox_test -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i ./_build/wasm-gc/release/check/lib/lib.mi:lib -i ./_build/wasm-gc/release/check/main/main.mi:main -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main_blackbox_test:./main -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check ./lib3/hello.mbt -o ./_build/wasm-gc/release/check/lib3/lib3.mi -pkg username/hello/lib3 -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib3:./lib3 -target wasm-gc -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check ./lib3/hello_test.mbt -doctest-only ./lib3/hello.mbt -include-doctests -o ./_build/wasm-gc/release/check/lib3/lib3.blackbox_test.mi -pkg username/hello/lib3_blackbox_test -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i ./_build/wasm-gc/release/check/lib3/lib3.mi:lib3 -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib3_blackbox_test:./lib3 -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check ./lib2/hello.mbt -o ./_build/wasm-gc/release/check/lib2/lib2.mi -pkg username/hello/lib2 -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib2:./lib2 -target wasm-gc -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check ./lib2/hello_test.mbt -doctest-only ./lib2/hello.mbt -include-doctests -o ./_build/wasm-gc/release/check/lib2/lib2.blackbox_test.mi -pkg username/hello/lib2_blackbox_test -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i ./_build/wasm-gc/release/check/lib2/lib2.mi:lib2 -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib2_blackbox_test:./lib2 -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
            moonc check ./lib/hello_test.mbt -doctest-only ./lib/hello.mbt -include-doctests -o ./_build/wasm-gc/release/check/lib/lib.blackbox_test.mi -pkg username/hello/lib_blackbox_test -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i ./_build/wasm-gc/release/check/lib/lib.mi:lll -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib_blackbox_test:./lib -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./_build/wasm-gc/release/check/all_pkgs.json
        "#]],
    );
...
fn test_dont_link_third_party() {
    ...
    check(
        get_stdout(&dir, ["build", "--dry-run", "--sort-input"]),
        expect![[r#"
            moonc build-package ./main/main.mbt -o ./_build/wasm-gc/debug/build/main/main.core -pkg hello/main -is-main -std-path '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/_build/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources hello/main:./main -target wasm-gc -g -O0 -source-map -workspace-path . -all-pkgs ./_build/wasm-gc/debug/build/all_pkgs.json
