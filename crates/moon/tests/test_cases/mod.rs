...
fn test_moon_pkg() {
    ...
    check(
        ...
        expect![[r#"
            ...
            moonc check ./pkg/pkg.mbt -w -unused_value-todo -o ./target/wasm-gc/release/check/pkg/pkg.mi -pkg user/mod/pkg -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources user/mod/pkg:./pkg -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check ./pkg/pkg_test.mbt -doctest-only ./pkg/pkg.mbt -include-doctests -w -unused_value-todo -o ./target/wasm-gc/release/check/pkg/pkg.blackbox_test.mi -pkg user/mod/pkg_blackbox_test -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/pkg/pkg.mi:pkg -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources user/mod/pkg_blackbox_test:./pkg -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check ./main/main.mbt -o ./target/wasm-gc/release/check/main/main.mi -pkg user/mod/main -is-main -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/pkg/pkg.mi:lib -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources user/mod/main:./main -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check -doctest-only ./main/main.mbt -include-doctests -o ./target/wasm-gc/release/check/main/main.blackbox_test.mi -pkg user/mod/main_blackbox_test -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/pkg/pkg.mi:lib -i ./target/wasm-gc/release/check/main/main.mi:main -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources user/mod/main_blackbox_test:./main -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
        "#]],
    );
    check(
        ...
        expect![[r#"
            cat ./pkg/pkg.mbt '>' ./pkg/gen.txt
            moonc build-package ./pkg/pkg.mbt -w -unused_value-todo -o ./target/wasm-gc/release/build/pkg/pkg.core -pkg user/mod/pkg -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources user/mod/pkg:./pkg -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/build/all_pkgs.json
            ...
            moonc build-package ./main/main.mbt -o ./target/wasm-gc/release/build/main/main.core -pkg user/mod/main -is-main -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/build/pkg/pkg.mi:lib -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources user/mod/main:./main -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/build/all_pkgs.json
...
fn test_need_link() {
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./lib/hello.mbt -o ./target/wasm-gc/release/build/lib/lib.core -pkg username/hello/lib -pkg-sources username/hello/lib:./lib -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/build/all_pkgs.json
            moonc build-package ./main/main.mbt -o ./target/wasm-gc/release/build/main/main.core -pkg username/hello/main -is-main -i ./target/wasm-gc/release/build/lib/lib.mi:lib -pkg-sources username/hello/main:./main -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/build/all_pkgs.json
...
fn test_export_memory_name() {
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./lib/hello.mbt -o ./target/wasm-gc/release/build/lib/lib.core -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib:./lib -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/build/all_pkgs.json
            moonc build-package ./main/main.mbt -o ./target/wasm-gc/release/build/main/main.core -pkg username/hello/main -is-main -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/build/lib/lib.mi:lib -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main:./main -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/build/all_pkgs.json
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./lib/hello.mbt -o ./target/wasm/release/build/lib/lib.core -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/wasm/release/bundle' -i '$MOON_HOME/lib/core/target/wasm/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib:./lib -target wasm -workspace-path . -all-pkgs ./target/wasm/release/build/all_pkgs.json
            moonc build-package ./main/main.mbt -o ./target/wasm/release/build/main/main.core -pkg username/hello/main -is-main -std-path '$MOON_HOME/lib/core/target/wasm/release/bundle' -i ./target/wasm/release/build/lib/lib.mi:lib -i '$MOON_HOME/lib/core/target/wasm/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main:./main -target wasm -workspace-path . -all-pkgs ./target/wasm/release/build/all_pkgs.json
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./lib/hello.mbt -o ./target/js/release/build/lib/lib.core -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/js/release/bundle' -i '$MOON_HOME/lib/core/target/js/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib:./lib -target js -workspace-path . -all-pkgs ./target/js/release/build/all_pkgs.json
            moonc build-package ./main/main.mbt -o ./target/js/release/build/main/main.core -pkg username/hello/main -is-main -std-path '$MOON_HOME/lib/core/target/js/release/bundle' -i ./target/js/release/build/lib/lib.mi:lib -i '$MOON_HOME/lib/core/target/js/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main:./main -target js -workspace-path . -all-pkgs ./target/js/release/build/all_pkgs.json
...
fn test_import_memory_and_heap_start() {
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./lib/hello.mbt -o ./target/wasm/release/build/lib/lib.core -pkg username/hello/lib -pkg-sources username/hello/lib:./lib -target wasm -workspace-path . -all-pkgs ./target/wasm/release/build/all_pkgs.json
            moonc build-package ./main/main.mbt -o ./target/wasm/release/build/main/main.core -pkg username/hello/main -is-main -i ./target/wasm/release/build/lib/lib.mi:lib -pkg-sources username/hello/main:./main -target wasm -workspace-path . -all-pkgs ./target/wasm/release/build/all_pkgs.json
...
fn test_moon_run_single_file_dry_run() {
    ...
    check(
        &output,
        expect![[r#"
            moonc build-package ./single.mbt -o ./target/native/release/build/single/single.core -pkg moon/test/single -is-main -std-path '$MOON_HOME/lib/core/target/native/release/bundle' -i '$MOON_HOME/lib/core/target/native/release/bundle/abort/abort.mi:abort' -i '$MOON_HOME/lib/core/target/native/release/bundle/array/array.mi:array' -i '$MOON_HOME/lib/core/target/native/release/bundle/bench/bench.mi:bench' -i '$MOON_HOME/lib/core/target/native/release/bundle/bigint/bigint.mi:bigint' -i '$MOON_HOME/lib/core/target/native/release/bundle/bool/bool.mi:bool' -i '$MOON_HOME/lib/core/target/native/release/bundle/buffer/buffer.mi:buffer' -i '$MOON_HOME/lib/core/target/native/release/bundle/builtin/builtin.mi:builtin' -i '$MOON_HOME/lib/core/target/native/release/bundle/byte/byte.mi:byte' -i '$MOON_HOME/lib/core/target/native/release/bundle/bytes/bytes.mi:bytes' -i '$MOON_HOME/lib/core/target/native/release/bundle/char/char.mi:char' -i '$MOON_HOME/lib/core/target/native/release/bundle/cmp/cmp.mi:cmp' -i '$MOON_HOME/lib/core/target/native/release/bundle/coverage/coverage.mi:coverage' -i '$MOON_HOME/lib/core/target/native/release/bundle/deque/deque.mi:deque' -i '$MOON_HOME/lib/core/target/native/release/bundle/double/double.mi:double' -i '$MOON_HOME/lib/core/target/native/release/bundle/env/env.mi:env' -i '$MOON_HOME/lib/core/target/native/release/bundle/error/error.mi:error' -i '$MOON_HOME/lib/core/target/native/release/bundle/float/float.mi:float' -i '$MOON_HOME/lib/core/target/native/release/bundle/hashmap/hashmap.mi:hashmap' -i '$MOON_HOME/lib/core/target/native/release/bundle/hashset/hashset.mi:hashset' -i '$MOON_HOME/lib/core/target/native/release/bundle/immut/array/array.mi:immut/array' -i '$MOON_HOME/lib/core/target/native/release/bundle/immut/hashmap/hashmap.mi:immut/hashmap' -i '$MOON_HOME/lib/core/target/native/release/bundle/immut/hashset/hashset.mi:immut/hashset' -i '$MOON_HOME/lib/core/target/native/release/bundle/immut/list/list.mi:immut/list' -i '$MOON_HOME/lib/core/target/native/release/bundle/immut/priority_queue/priority_queue.mi:immut/priority_queue' -i '$MOON_HOME/lib/core/target/native/release/bundle/immut/sorted_map/sorted_map.mi:immut/sorted_map' -i '$MOON_HOME/lib/core/target/native/release/bundle/immut/sorted_set/sorted_set.mi:immut/sorted_set' -i '$MOON_HOME/lib/core/target/native/release/bundle/int/int.mi:int' -i '$MOON_HOME/lib/core/target/native/release/bundle/int16/int16.mi:int16' -i '$MOON_HOME/lib/core/target/native/release/bundle/int64/int64.mi:int64' -i '$MOON_HOME/lib/core/target/native/release/bundle/json/json.mi:json' -i '$MOON_HOME/lib/core/target/native/release/bundle/list/list.mi:list' -i '$MOON_HOME/lib/core/target/native/release/bundle/math/math.mi:math' -i '$MOON_HOME/lib/core/target/native/release/bundle/option/option.mi:option' -i '$MOON_HOME/lib/core/target/native/release/bundle/prelude/prelude.mi:prelude' -i '$MOON_HOME/lib/core/target/native/release/bundle/priority_queue/priority_queue.mi:priority_queue' -i '$MOON_HOME/lib/core/target/native/release/bundle/queue/queue.mi:queue' -i '$MOON_HOME/lib/core/target/native/release/bundle/quickcheck/quickcheck.mi:quickcheck' -i '$MOON_HOME/lib/core/target/native/release/bundle/random/random.mi:random' -i '$MOON_HOME/lib/core/target/native/release/bundle/ref/ref.mi:ref' -i '$MOON_HOME/lib/core/target/native/release/bundle/string/regex/regex.mi:regex' -i '$MOON_HOME/lib/core/target/native/release/bundle/result/result.mi:result' -i '$MOON_HOME/lib/core/target/native/release/bundle/set/set.mi:set' -i '$MOON_HOME/lib/core/target/native/release/bundle/sorted_map/sorted_map.mi:sorted_map' -i '$MOON_HOME/lib/core/target/native/release/bundle/sorted_set/sorted_set.mi:sorted_set' -i '$MOON_HOME/lib/core/target/native/release/bundle/quickcheck/splitmix/splitmix.mi:splitmix' -i '$MOON_HOME/lib/core/target/native/release/bundle/strconv/strconv.mi:strconv' -i '$MOON_HOME/lib/core/target/native/release/bundle/string/string.mi:string' -i '$MOON_HOME/lib/core/target/native/release/bundle/test/test.mi:test' -i '$MOON_HOME/lib/core/target/native/release/bundle/tuple/tuple.mi:tuple' -i '$MOON_HOME/lib/core/target/native/release/bundle/uint/uint.mi:uint' -i '$MOON_HOME/lib/core/target/native/release/bundle/uint16/uint16.mi:uint16' -i '$MOON_HOME/lib/core/target/native/release/bundle/uint64/uint64.mi:uint64' -i '$MOON_HOME/lib/core/target/native/release/bundle/unit/unit.mi:unit' -i '$MOON_HOME/lib/core/target/native/release/bundle/encoding/utf16/utf16.mi:utf16' -i '$MOON_HOME/lib/core/target/native/release/bundle/encoding/utf8/utf8.mi:utf8' -pkg-sources moon/test/single:. -target native -workspace-path . -all-pkgs ./target/native/release/build/all_pkgs.json
...
fn test_moon_doc_dry_run() {
    ...
    check(
        ...
        expect![[r#"
            moonc check ./src/lib/hello.mbt -o ./target/wasm-gc/release/check/lib/lib.mi -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib:./src/lib -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check ./src/main/main.mbt -o ./target/wasm-gc/release/check/main/main.mi -pkg username/hello/main -is-main -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/lib/lib.mi:lib -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main:./src/main -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
...
fn test_moon_check_filter_package() {
    ...
    check(
        ...
        expect![[r#"
            moonc check ./lib2/lib.mbt -o ./target/wasm-gc/release/check/lib2/lib2.mi -pkg username/hello/lib2 -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib2:./lib2 -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check ./lib/hello.mbt -o ./target/wasm-gc/release/check/lib/lib.mi -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/lib2/lib2.mi:lib2 -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib:./lib -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check ./main/main.mbt -o ./target/wasm-gc/release/check/main/main.mi -pkg username/hello/main -is-main -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/lib/lib.mi:lib -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main:./main -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check -doctest-only ./main/main.mbt -include-doctests -o ./target/wasm-gc/release/check/main/main.blackbox_test.mi -pkg username/hello/main_blackbox_test -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/lib/lib.mi:lib -i ./target/wasm-gc/release/check/main/main.mi:main -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main_blackbox_test:./main -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
        "#]],
    );
    ...
    check(
        ...
        expect![[r#"
            moonc check ./lib2/lib.mbt -o ./target/wasm-gc/release/check/lib2/lib2.mi -pkg username/hello/lib2 -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib2:./lib2 -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check ./lib/hello.mbt -o ./target/wasm-gc/release/check/lib/lib.mi -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/lib2/lib2.mi:lib2 -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib:./lib -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check -doctest-only ./lib/hello.mbt -include-doctests -o ./target/wasm-gc/release/check/lib/lib.blackbox_test.mi -pkg username/hello/lib_blackbox_test -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/lib/lib.mi:lib -i ./target/wasm-gc/release/check/lib2/lib2.mi:lib2 -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib_blackbox_test:./lib -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
        "#]],
    );
}
...
fn test_moon_check_package_with_patch() {
    ...
    check(
        ...
        expect![[r#"
            moonc check ./lib2/lib.mbt -o ./target/wasm-gc/release/check/lib2/lib2.mi -pkg username/hello/lib2 -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib2:./lib2 -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check -patch-file /path/to/patch.json ./lib/hello.mbt -o ./target/wasm-gc/release/check/lib/lib.mi -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/lib2/lib2.mi:lib2 -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib:./lib -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check -doctest-only ./lib/hello.mbt -include-doctests -o ./target/wasm-gc/release/check/lib/lib.blackbox_test.mi -pkg username/hello/lib_blackbox_test -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/lib/lib.mi:lib -i ./target/wasm-gc/release/check/lib2/lib2.mi:lib2 -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib_blackbox_test:./lib -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
        "#]],
    );
    check(
...
fn test_add_mi_if_self_not_set_in_test_imports() {
    ...
    check(
        ...
        expect![[r#"
            ...
            moonc check ./main/main.mbt -o ./target/wasm-gc/release/check/main/main.mi -pkg username/hello/main -is-main -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/lib/lib.mi:lib -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main:./main -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check -doctest-only ./main/main.mbt -include-doctests -o ./target/wasm-gc/release/check/main/main.blackbox_test.mi -pkg username/hello/main_blackbox_test -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/lib/lib.mi:lib -i ./target/wasm-gc/release/check/main/main.mi:main -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main_blackbox_test:./main -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check ./lib3/hello.mbt -o ./target/wasm-gc/release/check/lib3/lib3.mi -pkg username/hello/lib3 -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib3:./lib3 -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check ./lib3/hello_test.mbt -doctest-only ./lib3/hello.mbt -include-doctests -o ./target/wasm-gc/release/check/lib3/lib3.blackbox_test.mi -pkg username/hello/lib3_blackbox_test -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/lib3/lib3.mi:lib3 -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib3_blackbox_test:./lib3 -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check ./lib2/hello.mbt -o ./target/wasm-gc/release/check/lib2/lib2.mi -pkg username/hello/lib2 -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib2:./lib2 -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check ./lib2/hello_test.mbt -doctest-only ./lib2/hello.mbt -include-doctests -o ./target/wasm-gc/release/check/lib2/lib2.blackbox_test.mi -pkg username/hello/lib2_blackbox_test -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/lib2/lib2.mi:lib2 -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib2_blackbox_test:./lib2 -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check ./lib/hello_test.mbt -doctest-only ./lib/hello.mbt -include-doctests -o ./target/wasm-gc/release/check/lib/lib.blackbox_test.mi -pkg username/hello/lib_blackbox_test -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./target/wasm-gc/release/check/lib/lib.mi:lll -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib_blackbox_test:./lib -target wasm-gc -blackbox-test -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
        "#]],
    );
...
fn test_dont_link_third_party() {
    ...
    check(
        get_stdout(&dir, ["build", "--dry-run", "--sort-input"]),
        expect![[r#"
            moonc build-package ./main/main.mbt -o ./target/wasm-gc/release/build/main/main.core -pkg hello/main -is-main -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources hello/main:./main -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/build/all_pkgs.json
...
#[test]
fn moon_single_file_stdlib() {
    let dir = TestDir::new("moon_test_single_file.in");
    check(
        get_stdout(&dir, ["run", "use_std.mbt"]),
        expect![[r#"
            Ok(42)
            @immut/array.from_array([1, 2, 3])
        "#]],
    );
    check(
        get_stdout(&dir, ["test", "use_std.mbt.md"]),
        expect![[r#"
            Ok(42)
            @immut/array.from_array([1, 2, 3])
            Total tests: 1, passed: 1, failed: 0.
