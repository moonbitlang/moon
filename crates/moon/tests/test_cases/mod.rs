...
fn test_moon_pkg() {
    ...
    check(
        ...
        expect![[r#"
            cat ./pkg/pkg.mbt '>' ./pkg/gen.txt
            moonc build-package ./pkg/pkg.mbt -w -unused_value-todo -o ./_build/wasm-gc/debug/build/pkg/pkg.core -pkg user/mod/pkg -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources user/mod/pkg:./pkg -target wasm-gc -g -O0 -source-map -workspace-path . -all-pkgs ./_build/wasm-gc/debug/build/all_pkgs.json
            ...
            moonc build-package ./main/main.mbt -o ./_build/wasm-gc/debug/build/main/main.core -pkg user/mod/main -is-main -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i ./_build/wasm-gc/debug/build/pkg/pkg.mi:lib -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources user/mod/main:./main -target wasm-gc -g -O0 -source-map -workspace-path . -all-pkgs ./_build/wasm-gc/debug/build/all_pkgs.json
...
fn test_export_memory_name() {
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./lib/hello.mbt -o ./_build/wasm/debug/build/lib/lib.core -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/wasm/release/bundle' -i '$MOON_HOME/lib/core/target/wasm/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib:./lib -target wasm -g -O0 -workspace-path . -all-pkgs ./_build/wasm/debug/build/all_pkgs.json
            moonc build-package ./main/main.mbt -o ./_build/wasm/debug/build/main/main.core -pkg username/hello/main -is-main -std-path '$MOON_HOME/lib/core/target/wasm/release/bundle' -i ./_build/wasm/debug/build/lib/lib.mi:lib -i '$MOON_HOME/lib/core/target/wasm/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main:./main -target wasm -g -O0 -workspace-path . -all-pkgs ./_build/wasm/debug/build/all_pkgs.json
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./lib/hello.mbt -o ./_build/js/debug/build/lib/lib.core -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/js/release/bundle' -i '$MOON_HOME/lib/core/target/js/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/lib:./lib -target js -g -O0 -source-map -workspace-path . -all-pkgs ./_build/js/debug/build/all_pkgs.json
            moonc build-package ./main/main.mbt -o ./_build/js/debug/build/main/main.core -pkg username/hello/main -is-main -std-path '$MOON_HOME/lib/core/target/js/release/bundle' -i ./_build/js/debug/build/lib/lib.mi:lib -i '$MOON_HOME/lib/core/target/js/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main:./main -target js -g -O0 -source-map -workspace-path . -all-pkgs ./_build/js/debug/build/all_pkgs.json
...
fn test_moon_run_with_cli_args() {
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./main/main_wasm.mbt -o ./_build/wasm-gc/debug/build/main/main.core -pkg username/hello/main -is-main -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources username/hello/main:./main -target wasm-gc -g -O0 -source-map -workspace-path . -all-pkgs ./_build/wasm-gc/debug/build/all_pkgs.json
...
fn test_moon_run_single_file_dry_run() {
    ...
    check(
        ...
        expect![[r#"
            ...
            cc -o ./_build/native/debug/build/runtime.o '-I$MOON_HOME/include' -g -c -fwrapv -fno-strict-aliasing -Wno-unused-value '$MOON_HOME/lib/runtime.c' -DMOONBIT_ALLOW_STACKTRACE
            cc -o ./_build/native/debug/build/single/single.exe '-I$MOON_HOME/include' -g -fwrapv -fno-strict-aliasing -Wno-unused-value '$MOON_HOME/lib/libmoonbitrun.o' ./_build/native/debug/build/single/single.c ./_build/native/debug/build/runtime.o -lm '$MOON_HOME/lib/libbacktrace.a'
    ...
    check(
        ...
        expect![[r#"
            ...
            cc -o ./_build/native/release/build/runtime.o '-I$MOON_HOME/include' -g -c -fwrapv -fno-strict-aliasing -Wno-unused-value -O2 '$MOON_HOME/lib/runtime.c'
            cc -o ./_build/native/release/build/single/single.exe '-I$MOON_HOME/include' -fwrapv -fno-strict-aliasing -Wno-unused-value '$MOON_HOME/lib/libmoonbitrun.o' ./_build/native/release/build/single/single.c ./_build/native/release/build/runtime.o -lm '$MOON_HOME/lib/libbacktrace.a'
...
fn test_moon_query() {
    ...
    check(
        ...
        expect![[r#"
            [["username/hello/lib6","$ROOT/target/wasm-gc/debug/build/lib6/lib6.mi","$ROOT/target/wasm-gc/debug/build/lib6/lib6.core"],["username/hello/lib7","$ROOT/target/wasm-gc/debug/build/lib7/lib7.mi","$ROOT/target/wasm-gc/debug/build/lib7/lib7.core"],["username/hello/lib3","$ROOT/target/wasm-gc/debug/build/lib3/lib3.mi","$ROOT/target/wasm-gc/debug/build/lib3/lib3.core"],["username/hello/lib1","$ROOT/target/wasm-gc/debug/build/lib1/lib1.mi","$ROOT/target/wasm-gc/debug/build/lib1/lib1.core"],["username/hello/lib5","$ROOT/target/wasm-gc/debug/build/lib5/lib5.mi","$ROOT/target/wasm-gc/debug/build/lib5/lib5.core"],["username/hello/lib4","$ROOT/target/wasm-gc/debug/build/lib4/lib4.mi","$ROOT/target/wasm-gc/debug/build/lib4/lib4.core"],["username/hello/lib2","$ROOT/target/wasm-gc/debug/build/lib2/lib2.mi","$ROOT/target/wasm-gc/debug/build/lib2/lib2.core"],["username/hello/lib","$ROOT/target/wasm-gc/debug/build/lib/lib.mi","$ROOT/target/wasm-gc/debug/build/lib/lib.core"],["username/hello/main","$ROOT/target/wasm-gc/debug/build/main/main.mi","$ROOT/target/wasm-gc/debug/build/main/main.core"]]
        "#]],
    );
...
fn test_strip_debug() {
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./lib/hello.mbt -o ./target/wasm-gc/debug/build/lib/lib.core -pkg moon_new/lib -std-path $MOON_HOME/lib/core/target/wasm-gc/release/bundle -pkg-sources moon_new/lib:./lib -target wasm-gc -g -O0 -source-map -g
            moonc build-package ./main/main.mbt -o ./target/wasm-gc/debug/build/main/main.core -pkg moon_new/main -is-main -std-path $MOON_HOME/lib/core/target/wasm-gc/release/bundle -i ./target/wasm-gc/debug/build/lib/lib.mi:lib -pkg-sources moon_new/main:./main -target wasm-gc -g -O0 -source-map -g
            moonc link-core $MOON_HOME/lib/core/target/wasm-gc/release/bundle/abort/abort.core $MOON_HOME/lib/core/target/wasm-gc/release/bundle/core.core ./target/wasm-gc/debug/build/lib/lib.core ./target/wasm-gc/debug/build/main/main.core -main moon_new/main -o ./target/wasm-gc/debug/build/main/main.wasm -pkg-config-path ./main/moon.pkg.json -pkg-sources moon_new/lib:./lib -pkg-sources moon_new/main:./main -pkg-sources moonbitlang/core:$MOON_HOME/lib/core -target wasm-gc -g -O0 -source-map -g
        "#]],
    );
    check(
        ...
        expect![[r#"
            moonc build-package ./lib/hello.mbt -o ./target/wasm-gc/debug/build/lib/lib.core -pkg moon_new/lib -std-path $MOON_HOME/lib/core/target/wasm-gc/release/bundle -pkg-sources moon_new/lib:./lib -target wasm-gc -g -O0 -source-map -O0 -source-map
            moonc build-package ./main/main.mbt -o ./target/wasm-gc/debug/build/main/main.core -pkg moon_new/main -is-main -std-path $MOON_HOME/lib/core/target/wasm-gc/release/bundle -i ./target/wasm-gc/debug/build/lib/lib.mi:lib -pkg-sources moon_new/main:./main -target wasm-gc -g -O0 -source-map -O0 -source-map
