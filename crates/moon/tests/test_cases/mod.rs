...
fn test_moon_run_single_file_dry_run() {
    ...
    check(
        &output,
        expect![[r#"
            moonc build-package ./single.mbt -o ./target/native/debug/build/single/single.core -pkg moon/test/single -is-main -std-path '$MOON_HOME/lib/core/target/native/release/bundle' -i '$MOON_HOME/lib/core/target/native/release/bundle/prelude/prelude.mi:prelude' -pkg-sources moon/test/single:. -target native -O0 -workspace-path . -all-pkgs ./target/native/debug/build/all_pkgs.json
    ...
    check(
        &output,
        expect![[r#"
            moonc build-package ./single.mbt -o ./target/js/debug/build/single/single.core -pkg moon/test/single -is-main -std-path '$MOON_HOME/lib/core/target/js/release/bundle' -i '$MOON_HOME/lib/core/target/js/release/bundle/prelude/prelude.mi:prelude' -pkg-sources moon/test/single:. -target js -O0 -workspace-path . -all-pkgs ./target/js/debug/build/all_pkgs.json
    ...
    check(
        &output,
        expect![[r#"
            moonc build-package ./single.mbt -o ./target/wasm-gc/debug/build/single/single.core -pkg moon/test/single -is-main -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -i '$MOON_HOME/lib/core/target/wasm-gc/release/bundle/prelude/prelude.mi:prelude' -pkg-sources moon/test/single:. -target wasm-gc -O0 -workspace-path . -all-pkgs ./target/wasm-gc/debug/build/all_pkgs.json
