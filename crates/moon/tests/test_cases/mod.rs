    ...
    // build
    {
        check(
            ...
            expect![[r#"
                ...
                cc -I$MOON_HOME/include -O2 $MOON_HOME/lib/libmoonbitrun.o -fwrapv -fno-strict-aliasing ./target/native/release/build/runtime.o ./target/native/release/build/main/main.c -lm -o ./target/native/release/build/main/main.exe
            "#]],
        );
        ...
        check(
            ...
            expect![[r#"
                ...
                cc -I$MOON_HOME/include -O2 $MOON_HOME/lib/libmoonbitrun.o -fwrapv -fno-strict-aliasing ./target/native/debug/build/runtime.o ./target/native/debug/build/main/main.c -lm -o ./target/native/debug/build/main/main.exe
            "#]],
        );
    }
    ...
    // test
    {
        check(
            ...
            expect![[r#"
                ...
                cc -I$MOON_HOME/include -O2 $MOON_HOME/lib/libmoonbitrun.o -fwrapv -fno-strict-aliasing ./target/native/release/test/runtime.o ./target/native/release/test/lib/lib.whitebox_test.c -lm -o ./target/native/release/test/lib/lib.whitebox_test.exe
                ...
                cc -I$MOON_HOME/include -O2 $MOON_HOME/lib/libmoonbitrun.o -fwrapv -fno-strict-aliasing ./target/native/release/test/runtime.o ./target/native/release/test/lib/lib.internal_test.c -lm -o ./target/native/release/test/lib/lib.internal_test.exe
            "#]],
        );
...
fn test_native_backend_cc_flags() {
    ...
    check(
        ...
        expect![[r#"
            ...
            cc -c $MOON_HOME/lib/runtime.c -I $MOON_HOME/include -o ./target/native/release/build/runtime.o
            cc -I$MOON_HOME/include -fwrapv -fno-strict-aliasing ccflags fasd ./target/native/release/build/runtime.o ./target/native/release/build/main/main.c cclinkflags -o ./target/native/release/build/main/main.exe
            ...
            cc -I$MOON_HOME/include -fwrapv -fno-strict-aliasing ccflags fasd ./target/native/release/build/runtime.o ./target/native/release/build/lib/lib.c cclinkflags -o ./target/native/release/build/lib/lib.exe
        "#]],
    );
    ...
    check(
        ...
        expect![[r#"
            ...
            cc -I$MOON_HOME/include -fwrapv -fno-strict-aliasing ccflags fasd ./target/native/debug/test/runtime.o ./target/native/debug/test/lib/lib.internal_test.c cclinkflags -o ./target/native/debug/test/lib/lib.internal_test.exe
        "#]],
    );
    // don't pass native cc flags for no native backend
    check(
