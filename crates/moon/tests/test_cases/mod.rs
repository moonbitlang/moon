...
fn test_sub_package() {
    ...
    check(
        ...
        expect![[r#"
            ...
            moon generate-test-driver --source-dir . --target-dir ./target --package moon_new/test --sort-input --target wasm-gc --driver-kind blackbox --mode test
            ...
            moon generate-test-driver --source-dir . --target-dir ./target --package moon_new/test --sort-input --target wasm-gc --driver-kind whitebox --mode test
