    ...
    // test
    {
        ...
        check(
            ...
            expect![[r#"
                ...
                tcc ./target/native/debug/test/lib/lib.whitebox_test.c ./target/native/debug/test/runtime.dylib -I$MOON_HOME/include -L$MOON_HOME/lib -DMOONBIT_NATIVE_NO_SYS_HEADER -o ./target/native/debug/test/lib/lib.whitebox_test.exe
                ...
                tcc ./target/native/debug/test/lib/lib.internal_test.c ./target/native/debug/test/runtime.dylib -I$MOON_HOME/include -L$MOON_HOME/lib -DMOONBIT_NATIVE_NO_SYS_HEADER -o ./target/native/debug/test/lib/lib.internal_test.exe
            "#]],
        );
    }
}
...
fn test_native_backend_cc_flags() {
    ...
    check(
        ...
        expect![[r#"
            ...
            cc $MOON_HOME/lib/runtime.c -shared -fPIC -I $MOON_HOME/include -o ./target/native/debug/test/runtime.dylib
            cc ./target/native/debug/test/lib/lib.internal_test.c ./target/native/debug/test/runtime.dylib -I$MOON_HOME/include -fwrapv -fno-strict-aliasing ccflags fasd cclinkflags -o ./target/native/debug/test/lib/lib.internal_test.exe
        "#]],
    );
    // don't pass native cc flags for no native backend
    check(
