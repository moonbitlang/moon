    ...
    // build
    {
        check(
            ...
            expect![[r#"
                ...
                cc ./target/native/release/build/main/main.c $MOON_HOME/lib/runtime.c -I$MOON_HOME/include -O2 $MOON_HOME/lib/libmoonbitrun.o -fwrapv -fno-strict-aliasing -lm -o ./target/native/release/build/main/main.exe
            "#]],
        );
        ...
        check(
            ...
            expect![[r#"
                ...
                cc ./target/native/debug/build/main/main.c $MOON_HOME/lib/runtime.c -I$MOON_HOME/include -O2 $MOON_HOME/lib/libmoonbitrun.o -fwrapv -fno-strict-aliasing -lm -o ./target/native/debug/build/main/main.exe
            "#]],
        );
    }
    ...
    // test
    {
        check(
            ...
            expect![[r#"
                ...
                cc ./target/native/release/test/lib/lib.whitebox_test.c $MOON_HOME/lib/runtime.c -I$MOON_HOME/include -O2 $MOON_HOME/lib/libmoonbitrun.o -fwrapv -fno-strict-aliasing -lm -o ./target/native/release/test/lib/lib.whitebox_test.exe
                ...
                cc ./target/native/release/test/lib/lib.internal_test.c $MOON_HOME/lib/runtime.c -I$MOON_HOME/include -O2 $MOON_HOME/lib/libmoonbitrun.o -fwrapv -fno-strict-aliasing -lm -o ./target/native/release/test/lib/lib.internal_test.exe
            "#]],
        );
        check(
            get_stdout(
            ...
            expect![[r#"
                ...
                cc ./target/native/debug/test/lib/lib.whitebox_test.c $MOON_HOME/lib/runtime.c -I$MOON_HOME/include -O2 $MOON_HOME/lib/libmoonbitrun.o -fwrapv -fno-strict-aliasing -lm -o ./target/native/debug/test/lib/lib.whitebox_test.exe
                ...
                cc ./target/native/debug/test/lib/lib.internal_test.c $MOON_HOME/lib/runtime.c -I$MOON_HOME/include -O2 $MOON_HOME/lib/libmoonbitrun.o -fwrapv -fno-strict-aliasing -lm -o ./target/native/debug/test/lib/lib.internal_test.exe
            "#]],
        );
    }
}
...
fn test_native_backend_cc_flags() {
    ...
    check(
        ...
        expect![[r#"
            ...
            cc ./target/native/release/build/main/main.c $MOON_HOME/lib/runtime.c -I$MOON_HOME/include -fwrapv -fno-strict-aliasing ccflags fasd cclinkflags -o ./target/native/release/build/main/main.exe
            ...
            cc ./target/native/release/build/lib/lib.c $MOON_HOME/lib/runtime.c -I$MOON_HOME/include -fwrapv -fno-strict-aliasing ccflags fasd cclinkflags -o ./target/native/release/build/lib/lib.exe
        "#]],
    );
    ...
    check(
        ...
        expect![[r#"
            ...
            cc ./target/native/debug/test/lib/lib.internal_test.c $MOON_HOME/lib/runtime.c -I$MOON_HOME/include -fwrapv -fno-strict-aliasing ccflags fasd cclinkflags -o ./target/native/debug/test/lib/lib.internal_test.exe
        "#]],
    );
    // don't pass native cc flags for no native backend
    check(
