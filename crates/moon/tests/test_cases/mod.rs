...
fn test_moon_test_hello_exec() {
    ...
    check(
        ...
        expect![[r#"
            moon generate-test-driver --source-dir . --target-dir ./target --package moonbitlang/hello/lib --sort-input --target wasm-gc --driver-kind whitebox --mode test
            ...
            moon generate-test-driver --source-dir . --target-dir ./target --package moonbitlang/hello/lib --sort-input --target wasm-gc --driver-kind internal --mode test
