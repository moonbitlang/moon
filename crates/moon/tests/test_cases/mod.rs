...
fn test_blackbox_test_core_override() {
    ...
    check(
        ...
        expect![[r#"
            ...
            moonc build-package ./builtin/main_test.mbt ./target/wasm-gc/debug/test/builtin/__generated_driver_for_blackbox_test.mbt -o ./target/wasm-gc/debug/test/builtin/builtin.blackbox_test.core -pkg moonbitlang/core/builtin_blackbox_test -is-main -std-path ./target/wasm-gc/release/bundle -i ./target/wasm-gc/debug/test/builtin/builtin.mi:builtin -pkg-sources moonbitlang/core/builtin_blackbox_test:./builtin -target wasm-gc -g -O0 -enable-coverage -coverage-package-override=moonbitlang/core/builtin -blackbox-test -no-mi
            moonc link-core ./target/wasm-gc/release/bundle/core.core ./target/wasm-gc/debug/test/builtin/builtin.blackbox_test.core -main moonbitlang/core/builtin_blackbox_test -o ./target/wasm-gc/debug/test/builtin/builtin.blackbox_test.wasm -test-mode -pkg-config-path ./builtin/moon.pkg.json -pkg-sources moonbitlang/core/builtin:./builtin -pkg-sources moonbitlang/core/builtin_blackbox_test:./builtin -exported_functions moonbit_test_driver_internal_execute,moonbit_test_driver_finish -target wasm-gc -g -O0
...
#[test]
fn test_post_build() {
    let dir = TestDir::new("post_build.in");
    ...
    check(
        ...
        expect![[r#"
            ...
            ───╯
            Finished. moon: ran 3 tasks, now up to date
            Executed 4 post-build tasks, now up to date
        "#]],
    );
    check(
        read(dir.join("src/lib/c.mbt")),
