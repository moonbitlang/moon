...
fn test_moon_bundle() {
    ...
    check(
        ...
        expect![[r#"
            ...
            moonc build-package ./A/lib.mbt -w -a -o ./_build/wasm-gc/release/bundle/A/A.core -pkg moonbitlang/core/A -pkg-type library -pkg-sources moonbitlang/core/A:./A -target wasm-gc -workspace-path . -all-pkgs ./_build/wasm-gc/release/bundle/all_pkgs.json
            moonc build-package ./C/lib.mbt -w -a -o ./_build/wasm-gc/release/bundle/C/C.core -pkg moonbitlang/core/C -pkg-type library -i ./_build/wasm-gc/release/bundle/A/A.mi:A -pkg-sources moonbitlang/core/C:./C -target wasm-gc -workspace-path . -all-pkgs ./_build/wasm-gc/release/bundle/all_pkgs.json
            moonc build-package ./B/lib.mbt -w -a -o ./_build/wasm-gc/release/bundle/B/B.core -pkg moonbitlang/core/B -pkg-type library -i ./_build/wasm-gc/release/bundle/A/A.mi:A -pkg-sources moonbitlang/core/B:./B -target wasm-gc -workspace-path . -all-pkgs ./_build/wasm-gc/release/bundle/all_pkgs.json
