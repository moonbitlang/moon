...
fn test_moon_run_single_file_dry_run() {
    ...
    check(
        ...
        expect![[r#"
            ...
            cc -o ./_build/native/debug/build/runtime/utf.o '-I$MOON_HOME/include' -g -c -fwrapv -fno-strict-aliasing -O2 -DMOONBIT_ALLOW_STACKTRACE '$MOON_HOME/lib/runtime/utf.c'
            cc -o ./_build/native/debug/build/runtime/sync_io.o '-I$MOON_HOME/include' -g -c -fwrapv -fno-strict-aliasing -O2 -DMOONBIT_ALLOW_STACKTRACE '$MOON_HOME/lib/runtime/sync_io.c'
            ...
            cc -o ./_build/native/debug/build/single/single.exe '-I$MOON_HOME/include' -g -fwrapv -fno-strict-aliasing -Og '$MOON_HOME/lib/libmoonbitrun.o' ./_build/native/debug/build/single/single.c ./_build/native/debug/build/libruntime.a -lm '$MOON_HOME/lib/libbacktrace.a'
    ...
    check(
        ...
        expect![[r#"
            ...
            ar -r -c -s ./_build/native/release/build/libruntime.a ./_build/native/release/build/runtime/backtrace.o ./_build/native/release/build/runtime/env.o ./_build/native/release/build/runtime/runtime.o ./_build/native/release/build/runtime/sync_io.o ./_build/native/release/build/runtime/utf.o '$MOON_HOME/lib/moonbit_simdutf.o' '$MOON_HOME/lib/simdutf.o'
            cc -o ./_build/native/release/build/single/single.exe '-I$MOON_HOME/include' -fwrapv -fno-strict-aliasing -O2 '$MOON_HOME/lib/libmoonbitrun.o' ./_build/native/release/build/single/single.c ./_build/native/release/build/libruntime.a -lm '$MOON_HOME/lib/libbacktrace.a'
