...
fn test_workspace_commands() {
    ...
    check(
        ...
        expect![[r#"
            ...
            moon generate-test-info --output-metadata ./_build/wasm-gc/debug/test/alice/app/main/__internal_test_info.json ./app/src/main/main.mbt --target wasm-gc --driver-kind internal
            moon render-test-driver --input-metadata ./_build/wasm-gc/debug/test/alice/app/main/__internal_test_info.json --output-driver ./_build/wasm-gc/debug/test/alice/app/main/__generated_driver_for_internal_test.mbt --pkg-name alice/app/main
            ...
            moon generate-test-info --output-metadata ./_build/wasm-gc/debug/test/alice/app/main/__blackbox_test_info.json ./app/src/main/main_test.mbt --doctest-only ./app/src/main/main.mbt --target wasm-gc --driver-kind blackbox
            moon render-test-driver --input-metadata ./_build/wasm-gc/debug/test/alice/app/main/__blackbox_test_info.json --output-driver ./_build/wasm-gc/debug/test/alice/app/main/__generated_driver_for_blackbox_test.mbt --pkg-name alice/app/main
            ...
            moon generate-test-info --output-metadata ./_build/wasm-gc/debug/test/alice/liba/lib/__internal_test_info.json ./liba/src/lib/lib.mbt --target wasm-gc --driver-kind internal
            moon render-test-driver --input-metadata ./_build/wasm-gc/debug/test/alice/liba/lib/__internal_test_info.json --output-driver ./_build/wasm-gc/debug/test/alice/liba/lib/__generated_driver_for_internal_test.mbt --pkg-name alice/liba/lib
            ...
            moon generate-test-info --output-metadata ./_build/wasm-gc/debug/test/alice/liba/lib/__blackbox_test_info.json ./liba/src/lib/lib_test.mbt --doctest-only ./liba/src/lib/lib.mbt --target wasm-gc --driver-kind blackbox
            moon render-test-driver --input-metadata ./_build/wasm-gc/debug/test/alice/liba/lib/__blackbox_test_info.json --output-driver ./_build/wasm-gc/debug/test/alice/liba/lib/__generated_driver_for_blackbox_test.mbt --pkg-name alice/liba/lib
