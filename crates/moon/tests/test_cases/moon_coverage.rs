...
fn test_moon_coverage_analyze_dry_run() {
    ...
    compare_graphs(
        ...
        expect![[r#"
            ...
            {"command":"moonc build-package ./lib2/hello.mbt -o ./_build/wasm-gc/debug/test/lib2/lib2.core -pkg username/hello/lib2 -pkg-type library -pkg-sources username/hello/lib2:./lib2 -target wasm-gc -g -O0 -source-map -enable-coverage -workspace-path . -all-pkgs ./_build/wasm-gc/debug/test/all_pkgs.json","inputs":["$MOON_HOME/bin/moonc","./lib2/hello.mbt","./lib2/moon.pkg.json"],"outputs":["./_build/wasm-gc/debug/test/lib2/lib2.mi","./_build/wasm-gc/debug/test/lib2/lib2.core"]}
            {"command":"moon generate-test-driver --output-driver ./_build/wasm-gc/debug/test/main/__generated_driver_for_blackbox_test.mbt --output-metadata ./_build/wasm-gc/debug/test/main/__blackbox_test_info.json --doctest-only ./main/main.mbt --target wasm-gc --pkg-name username/hello/main --enable-coverage --driver-kind blackbox","inputs":["./main/main.mbt","$MOON_HOME/bin/moon"],"outputs":["./_build/wasm-gc/debug/test/main/__generated_driver_for_blackbox_test.mbt","./_build/wasm-gc/debug/test/main/__blackbox_test_info.json"]}
            {"command":"moon generate-test-driver --output-driver ./_build/wasm-gc/debug/test/main/__generated_driver_for_internal_test.mbt --output-metadata ./_build/wasm-gc/debug/test/main/__internal_test_info.json ./main/main.mbt --target wasm-gc --pkg-name username/hello/main --enable-coverage --driver-kind internal","inputs":["./main/main.mbt","$MOON_HOME/bin/moon"],"outputs":["./_build/wasm-gc/debug/test/main/__generated_driver_for_internal_test.mbt","./_build/wasm-gc/debug/test/main/__internal_test_info.json"]}
            {"command":"moonc build-package ./_build/wasm-gc/debug/test/main/__generated_driver_for_blackbox_test.mbt -doctest-only ./main/main.mbt -o ./_build/wasm-gc/debug/test/main/main.blackbox_test.core -pkg username/hello/main_blackbox_test -pkg-type executable -i ./_build/wasm-gc/debug/test/lib/lib.mi:lib -i ./_build/wasm-gc/debug/test/lib2/lib2.mi:lib2 -i ./_build/wasm-gc/debug/test/main/main.mi:main -pkg-sources username/hello/main_blackbox_test:./main -target wasm-gc -g -O0 -source-map -blackbox-test -include-doctests -no-mi -test-mode -workspace-path . -all-pkgs ./_build/wasm-gc/debug/test/all_pkgs.json","inputs":["$MOON_HOME/bin/moonc","./_build/wasm-gc/debug/test/lib/lib.core","./_build/wasm-gc/debug/test/lib/lib.mi","./_build/wasm-gc/debug/test/lib2/lib2.core","./_build/wasm-gc/debug/test/lib2/lib2.mi","./_build/wasm-gc/debug/test/main/__generated_driver_for_blackbox_test.mbt","./_build/wasm-gc/debug/test/main/main.core","./_build/wasm-gc/debug/test/main/main.mi","./main/main.mbt","./main/moon.pkg.json"],"outputs":["./_build/wasm-gc/debug/test/main/main.blackbox_test.core"]}
            ...
            {"command":"moonc build-package ./main/main.mbt ./_build/wasm-gc/debug/test/main/__generated_driver_for_internal_test.mbt -o ./_build/wasm-gc/debug/test/main/main.internal_test.core -pkg username/hello/main -pkg-type executable -i ./_build/wasm-gc/debug/test/lib/lib.mi:lib -i ./_build/wasm-gc/debug/test/lib2/lib2.mi:lib2 -pkg-sources username/hello/main:./main -target wasm-gc -g -O0 -source-map -enable-coverage -no-mi -test-mode -workspace-path . -all-pkgs ./_build/wasm-gc/debug/test/all_pkgs.json","inputs":["$MOON_HOME/bin/moonc","./_build/wasm-gc/debug/test/lib/lib.core","./_build/wasm-gc/debug/test/lib/lib.mi","./_build/wasm-gc/debug/test/lib2/lib2.core","./_build/wasm-gc/debug/test/lib2/lib2.mi","./_build/wasm-gc/debug/test/main/__generated_driver_for_internal_test.mbt","./main/main.mbt","./main/moon.pkg.json"],"outputs":["./_build/wasm-gc/debug/test/main/main.internal_test.core"]}
            ...
            {"command":"moonc build-package ./main/main.mbt -o ./_build/wasm-gc/debug/test/main/main.core -pkg username/hello/main -pkg-type executable -i ./_build/wasm-gc/debug/test/lib/lib.mi:lib -i ./_build/wasm-gc/debug/test/lib2/lib2.mi:lib2 -pkg-sources username/hello/main:./main -target wasm-gc -g -O0 -source-map -enable-coverage -workspace-path . -all-pkgs ./_build/wasm-gc/debug/test/all_pkgs.json","inputs":["$MOON_HOME/bin/moonc","./_build/wasm-gc/debug/test/lib/lib.core","./_build/wasm-gc/debug/test/lib/lib.mi","./_build/wasm-gc/debug/test/lib2/lib2.core","./_build/wasm-gc/debug/test/lib2/lib2.mi","./main/main.mbt","./main/moon.pkg.json"],"outputs":["./_build/wasm-gc/debug/test/main/main.mi","./_build/wasm-gc/debug/test/main/main.core"]}
        "#]],
    );
}
