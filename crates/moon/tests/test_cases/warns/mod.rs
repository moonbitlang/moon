...
fn test_warn_list_dry_run() {
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./lib1/hello.mbt -w -1 -o ./target/wasm-gc/release/build/lib1/lib1.core -pkg username/hello/lib1 -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -pkg-sources username/hello/lib1:./lib1 -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/build/all_pkgs.json
            moonc build-package ./lib/hello.mbt -w -2 -o ./target/wasm-gc/release/build/lib/lib.core -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -pkg-sources username/hello/lib:./lib -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/build/all_pkgs.json
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./lib1/hello.mbt -w -1-29 -o ./target/wasm-gc/release/build/lib1/lib1.core -pkg username/hello/lib1 -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -pkg-sources username/hello/lib1:./lib1 -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/build/all_pkgs.json
            moonc build-package ./lib/hello.mbt -w -2-29 -o ./target/wasm-gc/release/build/lib/lib.core -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -pkg-sources username/hello/lib:./lib -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/build/all_pkgs.json
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./lib1/hello.mbt -w -a -o ./target/wasm-gc/release/bundle/lib1/lib1.core -pkg username/hello/lib1 -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -pkg-sources username/hello/lib1:./lib1 -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/bundle/all_pkgs.json
            moonc build-package ./lib/hello.mbt -w -a -o ./target/wasm-gc/release/bundle/lib/lib.core -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -pkg-sources username/hello/lib:./lib -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/bundle/all_pkgs.json
    ...
    check(
        ...
        expect![[r#"
            moonc check ./lib1/hello.mbt -w -1 -o ./target/wasm-gc/release/check/lib1/lib1.mi -pkg username/hello/lib1 -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -pkg-sources username/hello/lib1:./lib1 -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check ./lib/hello.mbt -w -2 -o ./target/wasm-gc/release/check/lib/lib.mi -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -pkg-sources username/hello/lib:./lib -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
    ...
    check(
        ...
        expect![[r#"
            moonc check ./lib1/hello.mbt -w -1-29 -o ./target/wasm-gc/release/check/lib1/lib1.mi -pkg username/hello/lib1 -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -pkg-sources username/hello/lib1:./lib1 -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
            moonc check ./lib/hello.mbt -w -2-29 -o ./target/wasm-gc/release/check/lib/lib.mi -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -pkg-sources username/hello/lib:./lib -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
...
fn test_alert_list() {
    ...
    check(
        ...
        expect![[r#"
            moonc check ./lib/hello.mbt -w -2 -alert -alert_1-alert_2 -o ./target/wasm-gc/release/check/lib/lib.mi -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -pkg-sources username/hello/lib:./lib -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
...
fn test_mod_level_warn_alert_list() {
    ...
    check(
        ...
        expect![[r#"
            moonc check ./lib/hello.mbt -w -1 -alert -alert_1 -o ./target/wasm-gc/release/check/lib/lib.mi -pkg username/hello/lib -std-path '$MOON_HOME/lib/core/target/wasm-gc/release/bundle' -pkg-sources username/hello/lib:./lib -target wasm-gc -workspace-path . -all-pkgs ./target/wasm-gc/release/check/all_pkgs.json
