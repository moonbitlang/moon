...
fn test_dummy_core() {
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./1/lib.mbt ./1/x.wasm-gc.mbt -o ./target/wasm-gc/debug/test/1/1.core -pkg moonbitlang/core/1 -pkg-sources moonbitlang/core/1:./1 -target wasm-gc -g -O0 -source-map
            ...
            moonc build-package ./2/lib.mbt -o ./target/wasm-gc/debug/test/2/2.core -pkg moonbitlang/core/2 -i ./target/wasm-gc/debug/test/1/1.mi:1 -pkg-sources moonbitlang/core/2:./2 -target wasm-gc -g -O0 -source-map
            moonc build-package -o ./target/wasm-gc/debug/test/prelude/prelude.core -pkg moonbitlang/core/prelude -pkg-sources moonbitlang/core/prelude:./prelude -target wasm-gc -g -O0 -source-map
            ...
            moonc build-package ./0/lib.mbt ./0/y.wasm-gc.mbt -o ./target/wasm-gc/debug/test/0/0.core -pkg moonbitlang/core/0 -pkg-sources moonbitlang/core/0:./0 -target wasm-gc -g -O0 -source-map
    ...
    check(
        ...
        expect![[r#"
            ...
            moonc build-package ./2/lib.mbt -o ./target/wasm/debug/test/2/2.core -pkg moonbitlang/core/2 -i ./target/wasm/debug/test/1/1.mi:1 -pkg-sources moonbitlang/core/2:./2 -target wasm -g -O0
            moonc build-package -o ./target/wasm/debug/test/prelude/prelude.core -pkg moonbitlang/core/prelude -pkg-sources moonbitlang/core/prelude:./prelude -target wasm -g -O0
            ...
            moonc build-package ./0/lib.mbt ./0/y.wasm.mbt -o ./target/wasm/debug/test/0/0.core -pkg moonbitlang/core/0 -pkg-sources moonbitlang/core/0:./0 -target wasm -g -O0
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./1/lib.mbt ./1/x.js.mbt -o ./target/js/debug/test/1/1.core -pkg moonbitlang/core/1 -pkg-sources moonbitlang/core/1:./1 -target js -g -O0 -source-map
            ...
            moonc build-package ./2/lib.mbt -o ./target/js/debug/test/2/2.core -pkg moonbitlang/core/2 -i ./target/js/debug/test/1/1.mi:1 -pkg-sources moonbitlang/core/2:./2 -target js -g -O0 -source-map
            moonc build-package -o ./target/js/debug/test/prelude/prelude.core -pkg moonbitlang/core/prelude -pkg-sources moonbitlang/core/prelude:./prelude -target js -g -O0 -source-map
            ...
            moonc build-package ./0/lib.mbt ./0/y.js.mbt -o ./target/js/debug/test/0/0.core -pkg moonbitlang/core/0 -pkg-sources moonbitlang/core/0:./0 -target js -g -O0 -source-map
    ...
    check(
        ...
        expect![[r#"
            ...
            moonc build-package ./1/lib.mbt ./1/x.wasm-gc.mbt -o ./target/wasm-gc/debug/test/1/1.core -pkg moonbitlang/core/1 -i ./target/wasm-gc/debug/test/coverage/coverage.mi:coverage -pkg-sources moonbitlang/core/1:./1 -target wasm-gc -g -O0 -source-map -enable-coverage
            ...
            moonc build-package ./2/lib.mbt -o ./target/wasm-gc/debug/test/2/2.core -pkg moonbitlang/core/2 -i ./target/wasm-gc/debug/test/1/1.mi:1 -i ./target/wasm-gc/debug/test/coverage/coverage.mi:coverage -pkg-sources moonbitlang/core/2:./2 -target wasm-gc -g -O0 -source-map -enable-coverage
            moonc build-package -o ./target/wasm-gc/debug/test/prelude/prelude.core -pkg moonbitlang/core/prelude -i ./target/wasm-gc/debug/test/coverage/coverage.mi:coverage -pkg-sources moonbitlang/core/prelude:./prelude -target wasm-gc -g -O0 -source-map -enable-coverage
            ...
            moonc build-package ./0/lib.mbt ./0/y.wasm-gc.mbt -o ./target/wasm-gc/debug/test/0/0.core -pkg moonbitlang/core/0 -i ./target/wasm-gc/debug/test/coverage/coverage.mi:coverage -pkg-sources moonbitlang/core/0:./0 -target wasm-gc -g -O0 -source-map -enable-coverage
