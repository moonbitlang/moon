...
/// Macro for defining feature gates with stability levels.
///
/// # Syntax
///
/// ```ignore
/// features! {
///     (stable, feature_name, "description"),   // enabled by default
///     (unstable, feature_name, "description"), // disabled by default
/// }
/// ```
macro_rules! features {
    ($(
        ...
        /// Collection of feature flags, generated by `features!` macro.
        #[derive(Debug, Clone)]
...
impl FromStr for FeatureGate {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        // By default, enable rr_moon_mod unless NEW_MOON_MOD=0 is set
        this.rr_moon_mod = true;
        if let Ok("0") = std::env::var("NEW_MOON_MOD").as_deref() {
            this.rr_moon_mod = false;
        }
