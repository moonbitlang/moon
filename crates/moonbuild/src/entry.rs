        ...
        match item {
            ...
            Err(TestFailedStatus::SnapshotPending(stat)) => {
                ...
                if auto_update {
                    ...
                    apply_snapshot(std::iter::once(stat.message.as_str()))?;
                    ...
                    if let Err(e) = apply_snapshot(std::iter::once(update_msg.as_str())) {
            ...
            Err(TestFailedStatus::ExpectTestFailed(origin_err)) => {
                ...
                if auto_update {
                    ...
                    if let Err(e) =
                        crate::expect::apply_expect(std::iter::once(update_msg.as_str()))
                    {
                    ...
                    while let Err(TestFailedStatus::ExpectTestFailed(ref etf)) = cur_res {
                        ...
                        if let Err(e) =
                            crate::expect::apply_expect(std::iter::once(etf.message.as_str()))
                        {
