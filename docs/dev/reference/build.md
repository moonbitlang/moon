...
| ----------------- | ------ | -------- | -------- | ------ | ----------- | ----------------------------- |
| **Source**        | x      |          |          | x      | no          | The package itself            |
| **Inline test**   | x      |          |          | x      | yes         | Tests written in source files |
| **Whitebox test** | x      | x        |          | x      | yes         | Sees private defs in source   |
| **Blackbox test** |        |          | x        |        | yes         | Depend on Source              |
...
specified in an additional import field named `wbtest_import` and `test_import`.
