...
Repeated imports within the same import kind produce a warning when their
conditions overlap. They remain valid and keep their declaration order.
Imports with disjoint conditions do not produce a duplicate warning.
